...
This Code of Conduct applies within all project spaces, including but not limited to GitHub repositories, issue trackers, pull requests, discussions, and any other communication channels related to the project. It also applies when an individual is representing the project or its community in public spaces.
